...
<div class="wrapper">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled components">
            ...
            <li>
                <a href="?page=usuarios" class="<?= $page=='usuarios'?'active':'' ?>" title="Usuários">
                    <i class="bi bi-people"></i><span class="nav-label">Usuários</span>
                </a>
            </li>
            <li>
                <a href="?page=participacoes" class="<?= $page=='participacoes'?'active':'' ?>" title="Participações">
                    <i class="bi bi-diagram-3"></i><span class="nav-label">Participações</span>
                </a>
            </li>
            <li>
                <a href="?page=projetos" class="<?= $page=='projetos'?'active':'' ?>" title="Projetos">
            ...
            <li>
                <a href="?page=visitas" class="<?= $page=='visitas'?'active':'' ?>" title="Visitas">
