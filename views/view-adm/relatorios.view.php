...
<div class="row g-3 mb-4">
    <div class="col-6 col-lg-3">
        <div style="background:#fff;border-radius:14px;padding:18px 20px 16px;box-shadow:0 2px 14px rgba(0,0,0,0.06);border-top:4px solid #3b82f6;position:relative;overflow:hidden;">
            ...
            <div style="display:inline-flex;align-items:center;gap:4px;font-size:0.7rem;font-weight:700;padding:2px 10px;border-radius:20px;background:#3b82f6;color:#fff;opacity:0.85;margin-bottom:10px;"><i class="bi bi-folder-fill"></i> Projetos Totais</div>
            <div class="fw-bold lh-1" style="font-size:2rem;color:#1e293b;"><?= $resumo['total_projetos'] ?></div>
        </div>
    </div>
    <div class="col-6 col-lg-3">
        <div style="background:#fff;border-radius:14px;padding:18px 20px 16px;box-shadow:0 2px 14px rgba(0,0,0,0.06);border-top:4px solid #3b82f6;position:relative;overflow:hidden;">
            ...
            <div class="fw-bold lh-1" style="font-size:2rem;color:#1e293b;"><?= $resumo['total_usuarios'] ?></div>
        </div>
    </div>
    <div class="col-6 col-lg-3">
        <div style="background:#fff;border-radius:14px;padding:18px 20px 16px;box-shadow:0 2px 14px rgba(0,0,0,0.06);border-top:4px solid #f97316;position:relative;overflow:hidden;">
            ...
            <div style="position:absolute;right:12px;bottom:6px;font-size:3rem;color:#f97316;opacity:0.1;line-height:1;pointer-events:none;"><i class="bi bi-diagram-3"></i></div>
            <div style="display:inline-flex;align-items:center;gap:4px;font-size:0.7rem;font-weight:700;padding:2px 10px;border-radius:20px;background:#f97316;color:#fff;opacity:0.85;margin-bottom:10px;"><i class="bi bi-diagram-3"></i> Participações</div>
            <div class="fw-bold lh-1" style="font-size:2rem;color:#1e293b;"><?= $resumo['total_participacoes'] ?></div>
        </div>
    </div>
    <div class="col-6 col-lg-3">
        <div style="background:#fff;border-radius:14px;padding:18px 20px 16px;box-shadow:0 2px 14px rgba(0,0,0,0.06);border-top:4px solid #f97316;position:relative;overflow:hidden;">
            <div style="position:absolute;inset:0;background:#f97316;opacity:0.04;pointer-events:none;"></div>
            <div style="position:absolute;right:12px;bottom:6px;font-size:3rem;color:#f97316;opacity:0.1;line-height:1;pointer-events:none;"><i class="bi bi-files"></i></div>
            <div style="display:inline-flex;align-items:center;gap:4px;font-size:0.7rem;font-weight:700;padding:2px 10px;border-radius:20px;background:#f97316;color:#fff;opacity:0.85;margin-bottom:10px;"><i class="bi bi-files"></i> Produções Cadastradas</div>
            <div class="fw-bold lh-1" style="font-size:2rem;color:#1e293b;"><?= $resumo['total_producoes'] ?></div>
        </div>
    </div>
</div>
...
<?php if (!empty($projetosPorTipo)): ?>
criarGrafico('graficoProjTipo', 'line',
...
<?php if (!empty($producoesPorTipo)): ?>
criarGrafico('graficoProducoes', 'line',
    ...
    [{ label: 'Produções', data: <?= json_encode(array_map(fn($r) => (int)$r['total'], $producoesPorTipo)) ?>,
       borderColor: '#64748b', backgroundColor: 'rgba(100,116,139,0.08)', fill: true, tension: 0.4, pointRadius: 4 }],
    { plugins: { legend: { display: false } }, scales: { y: { beginAtZero: true, ticks: { precision: 0 } } } }
);
<?php endif; ?>
