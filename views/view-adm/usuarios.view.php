...
<div class="row g-3 mb-4">
    <div class="col-sm-6 col-lg-3">
        <div style="background:#fff;border-radius:14px;padding:18px 20px 16px;box-shadow:0 2px 14px rgba(0,0,0,0.06);border-top:4px solid #3b82f6;position:relative;overflow:hidden;">
            ...
            <div style="display:inline-flex;align-items:center;gap:4px;font-size:0.7rem;font-weight:700;padding:2px 10px;border-radius:20px;background:#3b82f6;color:#fff;opacity:0.85;margin-bottom:10px;"><i class="bi bi-people"></i> Total de Usuários</div>
    ...
    <div class="col-sm-6 col-lg-3">
        <div style="background:#fff;border-radius:14px;padding:18px 20px 16px;box-shadow:0 2px 14px rgba(0,0,0,0.06);border-top:4px solid #22c55e;position:relative;overflow:hidden;">
            ...
            <div style="display:inline-flex;align-items:center;gap:4px;font-size:0.7rem;font-weight:700;padding:2px 10px;border-radius:20px;background:#22c55e;color:#fff;opacity:0.85;margin-bottom:10px;"><i class="bi bi-person-check"></i> Ativos</div>
    ...
    <div class="col-sm-6 col-lg-3">
        <div style="background:#fff;border-radius:14px;padding:18px 20px 16px;box-shadow:0 2px 14px rgba(0,0,0,0.06);border-top:4px solid #f97316;position:relative;overflow:hidden;">
            ...
            <div style="position:absolute;right:12px;bottom:6px;font-size:3rem;color:#f97316;opacity:0.1;line-height:1;pointer-events:none;"><i class="bi bi-person-x"></i></div>
            <div style="display:inline-flex;align-items:center;gap:4px;font-size:0.7rem;font-weight:700;padding:2px 10px;border-radius:20px;background:#f97316;color:#fff;opacity:0.85;margin-bottom:10px;"><i class="bi bi-person-x"></i> Inativos</div>
            <div class="fw-bold lh-1" style="font-size:2rem;color:#1e293b;"><?= $estatisticas['inativos'] ?></div>
        </div>
    </div>
    <div class="col-sm-6 col-lg-3">
        <div style="background:#fff;border-radius:14px;padding:18px 20px 16px;box-shadow:0 2px 14px rgba(0,0,0,0.06);border-top:4px solid #8b5cf6;position:relative;overflow:hidden;">
            ...
            <div style="position:absolute;right:12px;bottom:6px;font-size:3rem;color:#8b5cf6;opacity:0.1;line-height:1;pointer-events:none;"><i class="bi bi-person-badge"></i></div>
            <div style="display:inline-flex;align-items:center;gap:4px;font-size:0.7rem;font-weight:700;padding:2px 10px;border-radius:20px;background:#8b5cf6;color:#fff;opacity:0.85;margin-bottom:10px;"><i class="bi bi-person-badge"></i> Administradores</div>
            <div class="fw-bold lh-1" style="font-size:2rem;color:#1e293b;"><?= $estatisticas['admins'] ?></div>
        </div>
    </div>
</div>
